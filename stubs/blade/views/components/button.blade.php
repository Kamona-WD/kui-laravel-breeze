...
@php
    ...
    switch ($variant) {
        case 'primary':
            $variantClasses = 'bg-primary text-white hover:bg-primary-dark focus:ring-primary';
        break;
        case 'secondary':
            $variantClasses = 'bg-white text-gray-500 hover:bg-gray-100 focus:ring-primary dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
        break;
        case 'success':
        ...
        break;
        default:
            $variantClasses = 'bg-primary text-white hover:bg-purple-600 focus:ring-primary';
    }
